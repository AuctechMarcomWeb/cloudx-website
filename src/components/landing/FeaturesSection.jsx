...
const PANELS = [
  {
    ...
    features:[
      {icon:Users,      image:feat_multiSchool, title:'Multiple School Management',       desc:'Create, delegate, and manage schools with ease. Simplify your administrative tasks with our intuitive platform.'},
      {icon:CreditCard, image:feat_packages,    title:'Tailored Packages for Schools',    desc:"Design feature-wise packages for schools and classes. The options that best fit the institution's needs."},
      {icon:Settings,   image:feat_addons,      title:'Add-Ons - Enhanced Functionality', desc:'Unlock additional features for your school with our customisable add-ons.'},
      {icon:Shield,     image:feat_staff,       title:'Streamlined Staff Management',     desc:'Effortlessly assign permissions with role-based staff management. Organise and allocate responsibilities with ease.'},
      {icon:Home,       image:feat_website,     title:'Customize Website Settings',       desc:"Take control of the website's appearance and functionality with all-in-one settings management for the web."},
    ],
  },
  {
    ...
    features:[
      {icon:GraduationCap,image:feat_academy,    title:'Academy Setup Made Easy',        desc:'Simplify academy management with our all-in-one solution. From creating mediums, subjects, and semesters to managing shifts.'},
      {icon:Users,        image:feat_students,   title:'Effortless Student Management',  desc:'Create admission forms, add students individually or in bulk and manage parent details seamlessly.'},
      {icon:ClipboardList,image:feat_teachers,   title:'Streamlined Teacher Management', desc:'Effortlessly adding and managing teachers in the teacher section. Fill in all necessary information.'},
      {icon:Calendar,     image:feat_timetable,  title:'Flexible Timetable Creation',    desc:'Customize schedules for division and teachers effortlessly with our timetable section.'},
      {icon:Bell,         image:feat_announce,   title:'Announcements Made Simple',      desc:'Easily create and manage section-specific announcements. Keep your school community informed.'},
      {icon:BarChart2,    image:feat_exam,       title:'Effortless Exam Management',     desc:'Simplify exam scheduling and management with our online and offline sections.'},
      {icon:CreditCard,   image:feat_fees,       title:'Fees Management',                desc:'Create different types and maintain comprehensive logs of payments. Ensuring accurate records.'},
    ],
  },
  {
    ...
    features:[
      {icon:BookOpen,     image:feat_lessons,    title:'Lesson & Topic Crafting',               desc:'Teachers manage comprehensive lessons and break them down into topics for effective teaching and learning.'},
      {icon:ClipboardList,image:feat_assignments,title:'Assignments',                           desc:'Generate assignments by class, including weightage and resubmission options. Manage submitted student lists.'},
      {icon:Users,        image:feat_attendance, title:'Seamless Attendance Management',        desc:'Easily submit student attendance and view comprehensive attendance lists for effective record-keeping.'},
      {icon:BarChart2,    image:feat_exam,       title:'Efficient Offline/Online Exam Management',desc:'Exam processes by uploading offline exam marks and managing student-wise results.'},
      {icon:Calendar,     image:feat_timetable,  title:'Personalized Timetable',                desc:'Teachers to view their personalized timetables, ensuring they stay organized and prepared.'},
    ],
  },
  {
    ...
    features:[
      {icon:Home,         image:feat_parentsHome, title:'Attractive Home',                desc:'Keep up-to-date with the latest announcements and subject information right from our homepage.'},
      {icon:BookOpen,     image:feat_lessons,     title:'Subject Lessons and Assignments',desc:'Access subject-specific lessons and assignments, track submissions, and stay organized all in one place.'},
      {icon:Settings,     image:feat_website,     title:'Centralized School Operations',  desc:'Access all essential school management tools in one convenient menu section.'},
      {icon:GraduationCap,image:feat_academy,     title:'Elective Subject',              desc:"Simplify elective subject selection for students with our app's intuitive profile creation feature."},
    ],
  },
  {
    ...
    features:[
      {icon:BookOpen, image:feat_lessons,     title:'Subjects & Lessons',              desc:'Students can easily access subject materials, lesson topics, and study resources in one organized space.'},
      {icon:Bus,      image:feat_transport,   title:'Transportation Tracking',         desc:'Students can view their assigned bus route, pickup timings, and transport details.'},
      {icon:FileText, image:feat_assignments, title:'Assignment Management',           desc:'Students can check homework, submit assignments online, and stay updated with submission status.'},
      {icon:BarChart2,image:feat_exam,        title:'Exam Results (Online & Offline)', desc:'Students can view their exam scores, subject-wise marks, and performance reports for all assessments.'},
    ],
  },
  {
    ...
    features:[
      {icon:BarChart2,image:feat_staffDash,  title:'Attractive Dashboard',desc:'Easily access timetable, leave details, and holiday schedules all in one place.'},
      {icon:BookOpen, image:feat_lessons,    title:'Manage Lesson',       desc:'Subject teachers can easily manage lessons and topics with just a few clicks.'},
      {icon:FileText, image:feat_attendance, title:'Leaves',              desc:'Conveniently apply for leave. Only authorised persons can approve or reject leave requests.'},
      {icon:Calendar, image:feat_timetable,  title:'Timetable',           desc:'Teachers and staff users can view the class timetable, facilitating efficient scheduling.'},
      {icon:Bell,     image:feat_announce,   title:'Announcements',       desc:'Send important announcements directly from the application, ensuring timely communication.'},
    ],
  },
]
